...
// Output (O->T): Assembly 102, 124 DINTs = 496 bytes
// Config:        Assembly 105, 10 bytes
...
var identity = new IdentityInfo
{
    ...
    ProductName = "EthernetIPSharp Echo Module",
    Status = 0x0000,
};
...
var consumed = device.AddAssembly(102, 496, "O->T Output (124 DINTs)");
...
Log($"  Instance 102: O->T  496 bytes (124 DINTs) - waiting for PLC writes");
Log($"  Instance 105: Config  10 bytes");
Log("");
